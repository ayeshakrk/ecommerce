...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('frontend/css/themewar-icons.css')}}"/>
        ...
        <link rel="stylesheet" href="{{asset('frontend/css/ignore_in_wp.css')}}"/>
    ...
    <body>
        ...
        <!-- Header Start -->
        <header class="header-1 fix-header ">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-2 col-md-2">
                        <div class="logo">
                            <a href="index.html">
                                <img src="{{asset('frontend/images/logo.png')}}" alt="Goru"/>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="header-cogs">
                            ...
                            <a class="select-country" href="javascript:void(0);"><img src="{{asset('frontend//images/flag.png')}}" alt=""/>Eng</a>
