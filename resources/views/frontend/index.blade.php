...
<!-- Slider Start -->
        <section class="slider-01">
            ...
            <!-- Scroll Btn -->
            <div class="scroll-down"><a href="#coupone">scroll to explore</a><img src="{{asset('frontend/images/home/scroll.png')}}" alt=""></div>
            <!-- Scroll Btn -->
                    ...
                    <ul>
                        <li class="rev-slidebg">
                            ...
                            <div class="tp-caption tp-resizeme slider-image"
                                 ...
                                 style="z-index: 5;"><img src="{{asset('frontend/images/home/layer1.jpg')}}" alt="">
                            </div>
                        </li>
                        <li class="rev-slidebg">
                            <div class="tp-caption tp-resizeme textRes title-1"
        ...
        <section class="categorie-section">
            ...
            <!-- shpage -->
            <div class="cate-shage"><img src="{{asset('frontend/images/home/shape1.png')}}" alt=""></div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-service">
                            <img src="{{asset('frontend/images/home/truck.png')}}" alt="">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-service">
                            <img src="{{asset('frontend/images/home/headphone.png')}}" alt="">
                            <h4>24/7 Support</h4>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-service">
                            <img src="{{asset('frontend/images/home/undo.png')}}" alt="">
                            <h4>30 Day Return</h4>
                        ...
                        <div class="trending-slider owl-carousel">
                            <div class="row">
                                <div class="col-lg-7 col-md-7">
                                    <div class="single-trending-product">
                                        <div class="trend-thumb">
                                            <img src="{{asset('frontend/images/home/t1.jpg')}}" alt="">
                                        </div>
                                ...
                                <div class="col-lg-5 col-md-5">
                                    <div class="single-trending-product">
                                        <div class="trend-thumb">
                                            <img src="{{asset('frontend/images/home/t2.jpg')}}" alt="">
                                        </div>
                                        <div class="tr-pro-detail">
                                            <h3>
                            ...
                            <div class="tab-pane fade in" id="gadgets" role="tabpanel">
                                <div class="popular-tab-slider owl-carousel">
                                    <div class="pp-single-slider">
                                        <div class="single-popular-product">
                                            <div class="sp-thumb">
                                                <img src="{{asset('frontendimages/home/p5.jpg')}}" alt="">
                                                <div class="pro-badge">
                                                    <p class="sale">Sale</p>
                                                </div>
                                            </div>
        ...
        <section class="coupone-discount-sec" id="coupone">
            ...
            <!-- shape -->
            <div class="couple-shape"><img src="{{asset('frontend/images/home/shape3.png')}}" alt=""></div>
        </section>
        <!-- Coupon Discount End -->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-news">
                            <div class="news-thumb">
                                <img src="{{asset('frontend/images/home/blog/1.jpg')}}" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-news">
                            <div class="news-thumb">
                                <img src="{{asset('frontend/images/home/blog/2.jpg')}}" alt="">
                            </div>
                            <div class="news-details">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-news">
                            <div class="news-thumb">
                                <img src="{{asset('frontend/images/home/blog/3.jpg')}}" alt="">
                            </div>
                            <div class="news-details">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="client-logo owl-carousel">
                            <a href="#"><img src="{{asset('frontend/images/home/client-logo/1.png')}}" alt=""></a>
                            <a href="#"><img src="{{asset('frontend/images/home/client-logo/2.png')}}" alt=""></a>
                            <a href="#"><img src="{{asset('frontend/images/home/client-logo/3.png')}}" alt=""></a>
                            <a href="#"><img src="{{asset('frontend/images/home/client-logo/4.png')}}" alt=""></a>
                            <a href="#"><img src="{{asset('frontend/images/home/client-logo/5.png')}}" alt=""></a>
                            <a href="#"><img src="{{asset('frontend/images/home/client-logo/1.png')}}" alt=""></a>
                            <a href="#"><img src="{{asset('frontend/images/home/client-logo/2.png')}}" alt=""></a>
                            <a href="#"><img src="{{asset('frontend/images/home/client-logo/3.png')}}" alt=""></a>
                            <a href="#"><img src="{{asset('frontend/images/home/client-logo/4.png')}}" alt=""></a>
        ...
        <section class="mailchimp-section">
            ...
            <!-- shape -->
            <div class="mailchimp-shape"><img src="{{asset('frontend/images/home/shape4.png')}}" alt=""></div>
        </section>
